        ...
        <div class="container container-custom">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav m-auto">
                    <li class="nav-item mx-0 mx-lg-4"><a class="nav-link py-3 px-0 px-lg-3 rounded text-light" href="{{ route('home') }}">Beranda</a></li>
                    <li class="nav-item mx-0 mx-lg-4"><a class="nav-link py-3 px-0 px-lg-3 rounded text-light" href="{{ route('artikel') }}">Artikel</a></li>
                    <li class="nav-item mx-0 mx-lg-4"><a class="nav-link py-3 px-0 px-lg-3 rounded text-light" href="{{ route('galeri') }}">Galeri</a></li>
                    <li class="nav-item mx-0 mx-lg-4"><a class="nav-link py-3 px-0 px-lg-3 rounded text-light" href="{{ route('kontak') }}">Kontak</a></li>
                    @if(Auth::check())
                        <li class="nav-item mx-0 mx-lg-4"><a class="nav-link py-3 px-0 px-lg-3 rounded text-light" href="{{ route('dashboard') }}">Admin</a></li>
                    @else
                        <li class="nav-item mx-0 mx-lg-4"><a class="nav-link py-3 px-0 px-lg-3 rounded text-light" href="{{ route('login') }}">Login</a></li>
                    @endif
                </ul>
            </div>
        </div>
